...
<body>
	...
	<logic:iterate name="productList" id="product">
		...
		<div class="card"
			style="width: 257px; float: left; margin: 2%; height: 270px;">
			...
			<div class="card-body">
				...
				<logic:present name="username">
					<logic:equal name="available" value="true">
						...
						<a href="user.do?method=addToWishlist&id=${productid }"
						...
						<logic:notEqual name="productQuantity" value="0">
							<a href="user.do?method=addToCart&id=${productid}" style="float: left; margin: 0.5%;"
